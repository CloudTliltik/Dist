...
class Token
{
	...
	public static void main (String[] args) throws Exception
	{
		...
		w.join();
		System.out.println("ERROR AQUI, join");
		//8. En un ciclo:
		for (int i=1; i>0 ; )
		{
			...
			if (nodo == 0 && contador < 1000)
			{
				...
				if (primera_vez == true)
				{
					System.out.println("ERROR AQUI, primera primera_vez");
				...
				else//(primera_vez == false)
				{
					...
					System.out.println("\nEl valor del nodo es: " + nodo);
					System.out.println("\nEl valor del contador:" + contador);
					System.out.println("\nEl valor del token:" + token);
				}
			}
